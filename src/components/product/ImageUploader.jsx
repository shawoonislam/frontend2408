        ...
        {images.map((img, i) => (
          ...
          >
            ...
            <button
              type="button"
              onClick={() => setMain(i)}
              className={`absolute bottom-1.5 left-1.5 flex items-center gap-1 text-[10px] font-semibold px-2 py-1 rounded-full transition-colors ${
                img.isMain
                  ? "bg-amber text-ink"
